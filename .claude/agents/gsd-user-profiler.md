...
<reference>
@C:/Users/WhiteTom/Projects/Birthday/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/WhiteTom/Projects/Birthday/.claude/gsd-core/references/user-profiling.md` to load:
