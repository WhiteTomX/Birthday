...
- **Global scope**: `C:/Users/WhiteTom/Projects/Birthday/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/WhiteTom/Projects/Birthday/.claude/notes/`)
...
2. Glob `C:/Users/WhiteTom/Projects/Birthday/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/WhiteTom/Projects/Birthday/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/WhiteTom/Projects/Birthday/.claude/notes/` — works in any directory
