...
```
Agent(
  prompt="Read C:/Users/WhiteTom/Projects/Birthday/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/WhiteTom/Projects/Birthday/.claude/gsd-core/templates/VALIDATION.md`
