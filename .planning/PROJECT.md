...
A personal 30th birthday celebration website serving as the single source of truth for the event. Starts with a save-the-date RSVP collector, then evolves into a full event information hub with venue details, photo uploads, games, and a wishlist.
...
### Phase 1: Save-the-Date (MVP - ASAP)
- RSVP form collecting: name, contact method preference, plus-one count
- Each RSVP gets unique ID (no overwrites/duplicates)
- Contact methods: WhatsApp, Telegram, Signal, Discord, Matrix, SMS
- RSVP data stored in Cloudflare D1, not accessible via frontend
- Minimal branding (no special design requirements)

### Phase 2: Real Invitation (Post-Venue Decision - Weeks Away)
...
### Phase 3: Event Day Experience (Pre-event Build, Activate on Day)
...
- [ ] Placeholder for future venue details (Phase 2)
- [ ] Placeholder for future photo uploads (Phase 3)
- [ ] Placeholder for future wishlist (Phase 3)
